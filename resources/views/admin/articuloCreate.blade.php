...
@section('content')
    <div class="container">
      ...
      <form accept-charset="UTF-8" enctype="multipart/form-data" style="margin-top:2rem;" method="post" action="/api/admin/articulos" id="guardarBasicInfo">
        <fieldset>
          ...
          <div class="form-group row">
            <div class="form-group col-12">
              ...
              <div class="col-10">
                <input type="text" class="form-control" id="inputTitulo"  name="inputTitulo" placeholder="Título Articulo" value="{{Session::get('input')['inputTitulo']}}">
              </div>
            </div>
          </div>
          <div class="form-group row">
...
@section('javascript')
    ...
    <script>
      ...
      @if(isset(Session::get('input')['inputEstado']))
        @if(Session::get('input')['inputEstado'] == 1)
          document.getElementById("inputEstado1").checked = "true";
        @else(Session::get('input')['inputEstado2'] == 1)
