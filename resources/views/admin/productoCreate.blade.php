...
@section('content')
    <div class="container">
      ...
      @endif
      <form accept-charset="UTF-8" enctype="multipart/form-data" style="margin-top:2rem;" method="post" action="/api/admin/productos">
        <fieldset>
          ...
          <div class="form-group row">
            <div class="form-group col-6">
              ...
              <div class="input-group date form_date col-12" data-date="" data-date-format="yyyy mm dd" data-link-field="inputFechaInicio" data-link-format="yyyy-mm-dd" id='fechaInicio'>
                <input type="text" value="{{Session::get('input')['inputFechaInicio']}}" readonly id="showFechaInicio">
            ...
            <div class="form-group col-6">
              ...
              <div class="input-group date form_date col-12" data-date="" data-date-format="yyyy mm dd" data-link-field="inputFechaVencimiento" data-link-format="yyyy-mm-dd" id='fechaVenc'>
                <input type="text" value="{{Session::get('input')['inputFechaVencimiento']}}" readonly id="showFechaVencimiento">
                <span class="input-group-addon"><span class="glyphicon glyphicon-remove"></span></span>
              </div>
        ...
        <fieldset>
          ...
          <div class="form-group row">
            ...
            <div class="form-group col-4">
              <label for="inputBeneficioOperación" class="col-12 col-form-label">Beneficio de Operación</label>
              <div class="col-10">
                <input type="text" class="form-control" id="inputBeneficioOperación" name="inputBeneficioOperación" value="{{Session::get('input')['inputBeneficioOperación']}}">
              </div>
            </div>
          </div>
        </fieldset>
...
@section('javascript')
    ...
    <script>
      @if(Session::get('input')['inputEstadoSelect'])
        document.getElementById("inputEstadoSelect").querySelector("option[value='{{ Session::get('input')['inputEstadoSelect'] }}']").selected="true";
      @endif
    </script>
@endsection
